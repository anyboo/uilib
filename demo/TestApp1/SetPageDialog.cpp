#include "stdafx.h"
#include "SetPageDialog.h"

CSetPageDialog::CSetPageDialog(CRecord* cRcd)
{
	m_cRcd = cRcd;
}


CSetPageDialog::~CSetPageDialog()
{
}

LPCTSTR CSetPageDialog::GetWindowClassName() const
{
	return _T("MenuWnd");
}

UINT CSetPageDialog::GetClassStyle() const
{
	return UI_CLASSSTYLE_DIALOG;
}

void CSetPageDialog::OnFinalMessage(HWND /*hWnd*/)
{
	m_pm.RemovePreMessageFilter(this);
	delete this;
}

void CSetPageDialog::Init() {
...
void CSetPageDialog::Notify(TNotifyUI& msg)
{
...
LRESULT CSetPageDialog::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CSetPageDialog::OnNcHitTest(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CSetPageDialog::OnSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CSetPageDialog::OnGetMinMaxInfo(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CSetPageDialog::HandleMessage(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	LRESULT lRes = 0;
	BOOL bHandled = TRUE;
	switch (uMsg) {
...
LRESULT CSetPageDialog::MessageHandler(UINT uMsg, WPARAM wParam, LPARAM lParam, bool& bHandled)
{
	if (uMsg == WM_KEYDOWN) {
		if (wParam == VK_RETURN) {
